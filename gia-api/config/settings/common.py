...
REST_AUTH = {
    ...
    "JWT_TOKEN_CLAIMS_SERIALIZER": "apps.api.v1.dj_rest_auth.serializers.CustomTokenObtainPairSerializer",
    "PASSWORD_RESET_SERIALIZER": "apps.api.v1.dj_rest_auth.serializers.SitesDomainPasswordResetSerializer",
}
