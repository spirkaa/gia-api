...
def rename_org(value):
    ...
    value = value.replace(
        "Государственное автономное общеобразовательное учреждение дополнительного профессионального образования города Москвы",
        "ГАОУ ДПО",
    )
    value = value.replace(
    ...
    value = value.replace(
        "Государственное бюджетное профессиональное общеобразовательное учреждение (колледж) города Москвы",
        "ГБПОУ",
    )
    value = value.replace(
